...
public class StoryCardTab {
	...
	public TabItem create(TabFolder parent, ProjectModel pm){
		...
		state.setLayoutData(new GridData(GridData.END, GridData.CENTER, false,
				false));
	
		Composite compositeStateDis = new Composite(groupStoryCardState,
				SWT.NONE);
		...
		if (select == 2)
			btnStateProg.setSelection(true);
		...
		if (select == 4)
			btnStateComp.setSelection(true);
		...
		///////////////////////////////////////////////Estimates of the Cards//////////////////////////////////////////////////////////////////
	
		Group compositeShowInformationArea = new Group(storyCardTabComposite,
				SWT.NONE);
		...
		estimateLabel.setLayoutData(new GridData(GridData.END, GridData.CENTER,
				false, false));
		...
		btnDescription.addSelectionListener(new SelectionAdapter() {
			public void widgetSelected(SelectionEvent e) {
				Button button = (Button) e.widget;
				super.widgetSelected(e);
				System.out.println("Show Description clicked!"
						+ button.getSelection());
