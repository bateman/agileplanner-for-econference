...
public class IterationCardAvailableEffortCellEditorLocation implements CellEditorLocator {

    private IterationCardFigure iterationFigure;
    private IterationCardEditPart editpart;

    public IterationCardAvailableEffortCellEditorLocation(IterationCardFigure figure,IterationCardEditPart editpart) {
        ...
        rect.width = rect.width
                ...
                - ((rect.width / 2)
                        + ((System.getProperty("os.name").equalsIgnoreCase("Mac OS X")) ? CardConstants.MacIterationFigureAvailablePoint
                                : CardConstants.WindowsIterationFigureAvailablePoint) + 5);
        rect.height = 13 + trim.height;
        text.setBounds(rect.x
                + ((System.getProperty("os.name").equalsIgnoreCase("Mac OS X")) ? CardConstants.MacIterationFigureAvailablePoint
                        : (int)(CardConstants.WindowsIterationFigureAvailablePoint*ratio)), (int)((rect.y + 35)*ratio), (int)(rect.width*ratio),(int)(rect.height*ratio));
    }
